...
class ChimeraModelFromTemplate(ChimeraProtBase):
    ...
    def _defineParams(self, form):
        ...
        (In chimera main window, lower left corner you may see the status of 
        your job)\nStep 4: When finished click quit, 5 models will appear. 
        Choose the one you like best. Save it as first guess in Scipion by 
        executing the Chimera command *scipionwrite [model #n]* 
